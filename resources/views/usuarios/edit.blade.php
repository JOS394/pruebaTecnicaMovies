        ...
        <div class="col-md-8">
            ...
            @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="type_user"  id="type_user" class="form-control"  value="{{ old('type_user') }}" required autocomplete="type_user" autofocus>
             
              <option {{ $user->type_user == 1 ? 'selected' : '' }} value="{{ __('1') }}">Administrador</option>
              <option {{ $user->type_user == 0 ? 'selected' : '' }} value="{{ __('0') }}">Usuario Registrado</option>
